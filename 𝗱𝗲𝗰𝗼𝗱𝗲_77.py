...
am = ('\x1b[38;5;51mH','\x1b[38;5;63mA','\x1b[38;5;73m','\x1b[38;5;83mD','\x1b[38;5;93m','\x1b[38;5;103m')
for i in range(50):
    time.sleep(.1)
    sys.stdout.write("\rsufi... " + anim[i % len(anim)])
...
ID = input('  \x1b[38;5;117m{\x1b[1;32m🐺🇦🇱 \x1b[38;5;199m}  I̙͓̞D̪͕͚ \x1b[1;38;5;117m જ⁀➴  \x1b[38;5;130m︎')

token = input(''' 
   \x1b[38;5;117m{\x1b[1;32m🐺 \x1b[38;5;117m}  \x1b[38;5;190mT̶O̶K̶E̶N̶  \x1b[1;38;5;141m જ⁀➴   \x1b[38;5;130m''')
...
def qqq():
  while True:
    try:
      ...
      username = requests.post('https://www.instagram.com/api/graphql', headers=headers, data=data).json()['data']['user']['username']#['@M02MM']
